      ...
      <div className="width-wrapper flex-control">
        <div className="col-left">
          ...
          <div className="text-content">
            <AOSElement duration="900">
              <p>
                I am a self-taught Front End Web Developer passionate about
            ...
            <AOSElement duration="900">
              <p>
                Since 2021 I have been assisting local business owners by
          ...
          <AOSElement duration="900">
            <figure className="profile-img-container">
              <img
                ...
                alt="Jarol Riera profile picture"
              />
            </figure>
          </AOSElement>
        </div>
